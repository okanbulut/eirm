...
1. [Estimating dichotomous explanatory IRT models](https://okanbulut.github.io/eirm/vignettes/dich_vignette.html) with binary data (e.g., 0 = Wrong, 1 = Right)
2. [Estimating polytomous explanatory IRT models](https://okanbulut.github.io/eirm/vignettes/poly_vignette.html) with ordinal data (e.g., 1 = No, 2 = Maybe, 3 = Yes)
